...
template<std::semiregular EdgeType>
constexpr void algs4::DirectedCycle<EdgeType>::dfs(const detail::GraphBase<EdgeType> &G, int v) {
    onStack_[v] = true;
    marked_[v] = true;
...
template<std::semiregular EdgeType>
constexpr algs4::DirectedCycle<EdgeType>::DirectedCycle(const detail::GraphBase<EdgeType> &G)
